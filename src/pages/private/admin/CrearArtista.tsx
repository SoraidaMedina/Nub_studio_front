      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0, position: "relative", zIndex: 1 }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div>
              <div style={{ fontSize: 17, fontWeight: 900, color: C.text, lineHeight: 1 }}>Nuevo Artista</div>
              <div style={{ fontSize: 12, color: C.muted, marginTop: 3 }}>Registra un artista en el catálogo</div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            ...
            <button form="artista-form" type="submit" disabled={loading} style={{
            ...
            >
              {loading
                ...
                : <><Save size={15} strokeWidth={2.5} /> Guardar Artista</>
              }
            </button>
          </div>
        </div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
                      <div>
                        ...
                        <input name="nombre_completo" value={formData.nombre_completo} onChange={handleChange}
                          placeholder="Ej: María López Martínez" required disabled={loading}
                      ...
                      <div>
                        ...
                        <input name="nombre_artistico" value={formData.nombre_artistico} onChange={handleChange}
                          placeholder="Ej: La Mariposa Huasteca" disabled={loading}
                    ...
                    <div>
                      ...
                      <textarea name="biografia" value={formData.biografia} onChange={handleChange}
                        placeholder="Cuéntanos sobre el artista, su trayectoria y estilo…"
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
                    ...
                    <div>
                      ...
                      <input name="matricula" value={formData.matricula} onChange={handleChange}
                        placeholder="Ej: NUB-2024-001" disabled={loading}
